...
- 已按 LibTV 画布 case 补充工业化实验层：生产看板、实验队列、多机位九宫格、人物场景融合、moodboard、光影测试和 QA 标签。
...
- `PRODUCTION_BOARD.md`：参考 LibTV 画布后的可视化生产分区。
...
之前抓取的 `liblib_project_detail.json` 显示，那个画布不是“一次 prompt 出片”，而是 942 个节点组成的生产看板：图片资源 662 个、图片生成 115 个、分组 61 个、文本设定 53 个，视频生成只有 32 个。也就是说，视频之前的大量试错和筛选才是关键。
